...
parser.add_argument('--steps-per-epoch', type=int, default=99,
...
parser.add_argument('--pad-shape', nargs='+', type=int, default=[512, 512, 80],
                    help='crop or pad shape')
...
model_dir = args.model_dir + str(args.lr) + '_' + str(args.pad_shape[2]) + "/"
...
model.fit_generator(generator,
                    ...
                    callbacks=[save_callback, WandbCallback()],
                    verbose=1
                    )